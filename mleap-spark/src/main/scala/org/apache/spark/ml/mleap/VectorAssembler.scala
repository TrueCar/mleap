...
import org.apache.spark.mllib.linalg.{Vectors, Vector, VectorUDT => SparkVectorUDT}
...
class VectorAssembler(override val uid: String)
  ...
  override def transformSchema(schema: StructType): StructType = {
    ...
    inputDataTypes.foreach {
      ...
      case t if t.isInstanceOf[SparkVectorUDT] =>
      case other =>
    ...
    StructType(schema.fields :+ new StructField(outputColName, new SparkVectorUDT, true))
  }
}
...
class VectorAssemblerModel(override val uid: String,
  ...
  override def transform(dataset: DataFrame): DataFrame = {
    ...
    val args = $(inputCols).map { c =>
      schema(c).dataType match {
        ...
        case _: SparkVectorUDT => dataset(c)
  ...
  override def transformSchema(schema: StructType): StructType = {
    ...
    StructType(schema.fields :+ new StructField($(outputCol), new SparkVectorUDT, true))
  }
